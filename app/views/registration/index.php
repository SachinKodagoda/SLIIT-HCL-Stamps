...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT ?>/css/registration.css" />
...
<body>
    ...
    <script src="<?php echo URLROOT ?>/js/registration.js" type="text/javascript"></script>
</body>
